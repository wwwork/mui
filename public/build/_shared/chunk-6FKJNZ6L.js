...
function createBox(options = {}) {
  ...
  const Box = /* @__PURE__ */ React9.forwardRef(function Box2(inProps, ref) {
...
function isMuiElement(element, muiNames) {
  return /* @__PURE__ */ React11.isValidElement(element) && muiNames.indexOf(
...
function getValidReactChildren(children) {
  return React19.Children.toArray(children).filter((child) => /* @__PURE__ */ React19.isValidElement(child));
}
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(React29.Fragment, {
...
function createContainer(options = {}) {
  ...
  const Container = /* @__PURE__ */ React30.forwardRef(function Container2(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const Grid = /* @__PURE__ */ React31.forwardRef(function Grid2(inProps, ref) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(GridRoot, {
      ...
      children: React31.Children.map(children, (child) => {
        if (/* @__PURE__ */ React31.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
          return /* @__PURE__ */ React31.cloneElement(child, {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(/* @__PURE__ */ React32.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack = /* @__PURE__ */ React32.forwardRef(function Grid(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types16.default.object.isRequired
} : void 0;
...
var Typography = /* @__PURE__ */ React37.forwardRef(function Typography2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
true ? Typography.propTypes = {
   ...
   */
  color: import_prop_types17.default.oneOfType([import_prop_types17.default.oneOf(["primary", "secondary", "success", "error", "info", "warning", "textPrimary", "textSecondary", "textDisabled"]), import_prop_types17.default.string]),
  /**
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-6FKJNZ6L.js.map
